    ...
    const features: Feature[] = [
        {
            ...
            description: t('info.feature1Desc', { defaultValue: 'Get instant answers to your legal questions 24/7, in English. Our AI assistant is trained on Saudi Arabian legal documents.' }),
        ...
        {
            icon: 'translate',
            title: t('info.feature4Title', { defaultValue: 'English Support' }),
            description: t('info.feature4Desc', { defaultValue: 'Full support for English with clear, professional legal responses.' }),
            color: Colors.info,
        },
        {
            icon: 'clock-fast',
